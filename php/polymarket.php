...
class polymarket extends Exchange {
    ...
    public function fetch_markets(array $params = array ()): array {
    ...
    public function fetch_ticker(string $outcome, array $params = array ()): array {
        /**
        ...
        $midpointResponse = $this->clobPublicGetMidpoint (array( 'token_id' => $tokenId ));
        $bookResponse = $this->clobPublicGetBook (array( 'token_id' => $tokenId ));
    ...
    public function fetch_tickers(?array $outcomes, array $params = array ()): array {
        /**
        ...
        for ($outcomeSymbol of $targets) {
            $ticker = $this->fetch_ticker($outcomeSymbol, $params);
    ...
    public function fetch_order_book(string $outcome, ?int $limit = null, array $params = array ()): array {
        /**
    ...
    public function fetch_ohlcv(string $outcome, $timeframe = '1m', ?int $since = null, ?int $limit = null, array $params = array ()): array {
        /**
    ...
    public function fetch_trades(string $outcome, ?int $since = null, ?int $limit = null, array $params = array ()): array {
        /**
        ...
        $response = $this->clobPublicGetDataTrades ($this->extend($request, $params));
    ...
    public function fetch_balance(array $params = array ()): array {
        /**
        ...
        $response = $this->dataPrivateGetValue ($this->extend($request, $params));
    ...
    public function fetch_positions(?array $outcomes = null, array $params = array ()): array {
        /**
        ...
        $response = $this->dataPrivateGetPositions ($this->extend($request, $params));
    ...
    public function fetch_open_orders(?string $outcome = null, ?int $since = null, ?int $limit = null, array $params = array ()): array {
        /**
    ...
    public function fetch_order(?string $id, ?string $outcome = null, array $params = array ()): array {
        /**
    ...
    public function create_order(string $outcome, ?string $type, ?string $side, ?float $amount, ?float $price = null, array $params = array ()): array {
        /**
        ...
        $response = $this->clobPrivatePostOrder ($this->extend($request, $params));
        return $this->parse_order($response, $outcomeObj);
    }

    public function cancel_order(?string $id, ?string $outcome = null, array $params = array ()): array {
        /**
    ...
    public function cancel_all_orders(?string $outcome = null, array $params = array ()): array {
        /**
        ...
        $response = $this->clobPrivateDeleteOrders ($this->extend($request, $params));
        return $this->parse_orders($response);
    }

    public function fetch_events(array $queries = [], array $params = array ()): mixed {
        /**
        ...
        for ($q of $queries) {
            ...
            $firstRequest = array( 'page' => 1 );
            $first = $this->gammaPublicGetPublicSearch ($this->extend($firstRequest, $baseRequest, $rest));
            $firstEvents = $this->safe_list($first, 'events', array());
            $pagination = $this->safe_value($first, 'pagination', array());
            $totalResults = $this->safe_integer($pagination, 'totalResults', strlen($firstEvents));
            $totalPages = (int) ceil($totalResults / $pageSize);
